...
from axi.agents.discord_helpers import add_reaction, content_summary, remove_reaction, send_long, send_system
...
from axi.agents.sdk import as_stream, drain_sdk_buffer, drain_stderr
from axi.agents.state import agents, channel_to_agent
from axi.agents.streaming import handle_query_timeout, stream_with_retry
from axi.axi_types import ActivityState, AgentSession, ConcurrencyLimitError, MessageContent
from axi.channels import ensure_agent_channel, format_channel_topic, get_agent_channel, normalize_channel_name
from axi.prompts import compute_prompt_hash, make_spawned_agent_system_prompt
...
async def spawn_agent(
    ...
    from axi.agents.flowcoder import _run_flowcoder
...
async def process_message_queue(session: AgentSession) -> None:
    ...
    from axi.agents.state import shutdown_coordinator
